...
const handleSending = (req, res, next) => {
  tokenUrl.invalidateTokensForUser(req.user.id)
    ...
    .then((result) => {
      req.flash('success', {msg: '<strong>E-mail verzonden</strong><br />We hebben een e-mail gestuurd naar ' + req.user.email + ' met een link waarmee je eenmalig kan inloggen. <br />De verstuurde link is 48 uur geldig.<br /><br />Houd er rekening mee dat de e-mail wellicht in je spam-map terecht komt!'});
